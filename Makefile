...
MODULES = src/aodv src/helper src/cli/aodv_cli src/database/aodv_database src/database/timeslot src/database/broadcast_table/aodv_broadcast_t src/database/neighbor_table/nt \
	src/database/packet_buffer/packet_buffer src/database/rerr_log/rerr_log src/database/data_seq/data_seq src/database/data_monitor/data_monitor src/database/routing_table/aodv_rt src/database/rreq_log/rreq_log \
